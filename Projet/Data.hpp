...
const string hammerDescription = "This is an silver hammer. It is a very powrful hammer used to break the shaky grounds";
...
const string tvName = "Rounded 4K TV";
...
const string strawberryDescription = "This is a fresh strawberry, You cane eat it if you wanna had more calories to continue your way in the house";
...
const string usingMessageDesktop = "You're sending mails to the company that you work in";
...
const string ladderDescription = "This is Tall ladder made with black wood. Be carful when you use it";
...
const string ropeDescription = "This is Tall strong rope. You can use it to go up to the kitchen after you falled";
const string usingMessageRope ="";
