...
void GameView::setMap()
{
	...
	shared_ptr<Object> toboggant = make_shared<Object>(tobogganName, tobogganDescription, takingMessageToboggan, takingMessageToboggan, true);
...
{
	cout << ">>>>>>>> INF1015 DUNGEON CRAWLER 2022 <<<<<<<<<\n>  >  >  >  GAME OF THE YEAR EDITION  <  <  <  <\n\n";
}
...
pair<string, string>  GameView::splitCommande(string commande)
{
	...
	if (pos > 10000)
		...
		combination.second = commande.substr(pos+2);
	return combination;
}
